        ...
        <nav className="container-pad flex h-20 items-center justify-between">
          <Link to="/" className="flex items-center gap-3" onClick={() => setOpen(false)}>
            ...
            <span className="leading-tight">
              <span className="block text-sm font-black uppercase tracking-wide text-slate-950 dark:text-white">
                Victor.io
              </span>
              <span className="block text-xs font-semibold text-brand-700 dark:text-brand-200">
                Solutions
              </span>
            </span>
          </Link>
